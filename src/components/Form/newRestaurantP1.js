...
function NewRestaurantP1() {
    ...
    const [restaurant, setRestaurant] = React.useContext(restaurantContext);
            ...
            <form className="space-y-4 md:space-y-6">
                <div>
                    <label htmlFor="restaurantName"
                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Restaurant
                        Name:</label>
                    <div className="relative">
                        ...
                        <input type="text" aria-describedby="helper-text-explanation"
                               ...
                               value={restaurantName} onChange={handleChanges}/>
                    </div>
                </div>
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input type="text" id="address" name="address" aria-describedby="helper-text-explanation"
                               className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                               placeholder="Hämeenlinnantie 23D" pattern="^\d{5}(-\d{4})?$" required value={address}
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input type="text" id="city" name="city" aria-describedby="helper-text-explanation"
                               className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                               placeholder="Helsinki" pattern="^\d{5}(-\d{4})?$" required value={city}
                               onChange={handleChanges}/>
                    </div>
                </div>
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input type="text" id="zipCode" name="zipCode" aria-describedby="helper-text-explanation"
                               className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                               placeholder="12345" pattern="^\d{5}(-\d{4})?$" required value={zipCode}
                               onChange={handleChanges}/>
                    </div>
                ...
                <button onClick={handleSubmit} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">NEXT</button>
            </form>
        </div>
    );
}

export default NewRestaurantP1;